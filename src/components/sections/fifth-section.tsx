  ...
  const items: GridItemProps[] = [
    {
      ...
      description: (
        <p>
          ...
          <br />- Lực lượng duy nhất đủ bản lĩnh, trí tuệ lãnh đạo dân tộc{" "}
          <br />
    ...
    },
    {
      ...
      description: (
        <p>
          ...
          <br />
          <br />- Phong trào: Học tập và làm theo tư tưởng, đạo đức, phong cách
          Hồ Chí Minh
        </p>
      ),
      image:
        "https://tinhdoanbinhphuoc.vn/uploads/news/2016_09/193thongtincodong.png",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://a.tcnn.vn/Uploads/resources/truonghq/HT1/ktt_baovebacho1_kienthuc.jpg",
    },
    {
      ...
      description: (
        <p>
          ...
          <br />
          <br />- Đảng đại diện cho lợi ích dân tộc, gắn bó với nhân dân, đồng
          thời phát huy sức mạnh đại đoàn kết, kết hợp sức mạnh dân tộc với thời
          đại, tranh thủ sự ủng hộ quốc tế.
          <br />
          <br />- Trong bối cảnh hội nhập, Đảng kiên định đường lối đối ngoại
          độc lập, tự chủ, hòa bình, hợp tác và phát triển, giữ vững chủ quyền
...
const GridItem = ({
  ...
  return (
    <li
      onClick={onClick}
      className={`min-h-[14rem] list-none ${area} cursor-pointer`}
    >
      <div className="relative h-full rounded-2xl border p-2 md:rounded-3xl md:p-3">
        ...
        <div className="border-0.75 relative flex h-full flex-col justify-between gap-6 overflow-hidden rounded-xl p-6">
          ...
          <div className="w-fit rounded-lg border border-white/30 p-2 z-20 mt-2 ml-2">
            {icon}
          </div>
          <div className="space-y-3 z-20">
            <h3
              className={`font-sans text-xl md:text-3xl font-semibold ${
                textClassNameTitle || "text-black dark:text-white"
              }`}
            >
              {title}
            </h3>
